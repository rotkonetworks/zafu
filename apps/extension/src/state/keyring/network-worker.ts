...
export const startSyncInWorker = async (
  ...
  return callWorker(network, 'sync', { mnemonic, serverUrl, startHeight, backend }, walletId);
};
...
export const startWatchOnlySyncInWorker = async (
  ...
  return callWorker(network, 'sync', { mnemonic: '', serverUrl, startHeight, ufvk, backend }, walletId);
};
